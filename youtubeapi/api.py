...
class Api:
    ...
    def get_channel_playlists(self, channel_id, limit: int = 50) -> Union[PlaylistResponse, None]:
    ...
    def get_playlist_items(self, playlist_id: str, limit: int = 50) -> Union[PlaylistItemListResponse, None]:
